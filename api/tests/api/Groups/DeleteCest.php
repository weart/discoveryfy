...
{
    public function deleteGroupJson(ApiTester $I)
    {
        list($jwt, $group_uuid) = $this->createGroupJson($I);
    ...
    public function deleteGroupJsonApi(ApiTester $I)
    {
        list($jwt, $group_uuid) = $this->createGroupJson($I);
        $I->comment('Deleting the group: '.$group_uuid);
    ...
    // Copied from PostCest
    private function createGroupJson(ApiTester $I)
    {
