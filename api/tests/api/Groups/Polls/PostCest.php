...
class GroupsPollsPostCest
{
    public function createPollJson(Login $I, GroupsPostCest $groupsPost)
    {
        ...
        $I->seeItemResponseIsJsonSuccessful(HttpCode::CREATED, Data::pollResponseJsonType(), [
            'type'                              => 'polls',
    ...
    public function createPollJsonApi(Login $I, GroupsPostCest $groupsPost)
    {
        ...
        $I->seeItemResponseIsJsonApiSuccessful(HttpCode::CREATED, Data::pollResponseJsonApiType(), [
            'type'                               => 'polls',
            'attributes' => [
                'updated_at'                     => '',
                'name'                           => $poll_data['name'],
