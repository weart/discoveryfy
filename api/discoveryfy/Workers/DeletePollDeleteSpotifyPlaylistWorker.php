...
class DeletePollDeleteSpotifyPlaylistWorker extends BaseWorker
{
...
//        }
        ...
        $this->log(sprintf('Unfollow playlist: %s', $message->getProperty('spotify_playlist_uri')));
        $result = $this->getSpotifyApi()->unfollowPlaylist($message->getProperty('spotify_playlist_uri'));
