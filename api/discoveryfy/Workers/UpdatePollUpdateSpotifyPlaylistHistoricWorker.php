...
class UpdatePollUpdateSpotifyPlaylistHistoricWorker extends BaseWorker
{
...
//            throw new InternalServerErrorException('The property spotify_playlist_historic_uri is empty');
        ...
        return $this->returnResult(
            // Update Historic Playlist in Spotify
            $this->getSpotifyApi()->updatePlaylist($poll->get('spotify_playlist_historic_uri'), [
