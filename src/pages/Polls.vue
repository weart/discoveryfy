<template>
  <q-page>
    ...
    <div class="row q-pa-lg q-gutter-none justify-around full-width text-center">
      <h5 class="q-ma-sm col-12 text-weight-bold">Welcome to Discoveryfy</h5>
    ...
    <div class="row q-pa-md q-gutter-md justify-around items-start">
      <q-spinner-audio v-if="isLoading" color="primary" size="2em"/>

      <template v-if="!isLoading">
        <h6 class="full-width text-center q-ma-xs">Polls</h6>

        <pollCard v-for="poll in items" :key="poll.id" :poll="poll"/>
